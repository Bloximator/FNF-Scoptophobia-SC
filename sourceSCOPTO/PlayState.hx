...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'bloxiam':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bloxiam/bloxiamDialogue'));
			case 'gloomy-streets':
				dialogue = CoolUtil.coolTextFile(Paths.txt('gloomy-streets/gloomyDialogue'));	
			case 'taking-matters':
				dialogue = CoolUtil.coolTextFile(Paths.txt('taking-matters/takingDialogue'));	
			case 'the-clone':
				dialogue = CoolUtil.coolTextFile(Paths.txt('the-clone/cloneDialogue'));		
		}
		...
		gf = new Character(100, 130, gfVersion);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (SONG.noteStyle)
			{
				...
				default:
					babyArrow.frames = Paths.getSparrowAtlas('scopto/NOTE_assets_custom');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					{
					case 'taking-matters':
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/the-clone/vid.webm", new PlayState()));
					default:
